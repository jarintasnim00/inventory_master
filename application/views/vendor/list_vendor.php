...
<div class="row">
    <div class="col-lg-12">
        <div class="box light bordered">
            ...
            <span class="caption-subject font-blue-sharp bold uppercase">SUPPLIER | <a href='#myModal-1'
                                                                                      data-toggle='modal'
                                                                                      class='btn btn-info'>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body modal-edit">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-3 col-sm-3 control-label">QUALITY</label>
                                    <div class="col-lg-9">
                                        <select name="company_id" class="form-control">
...
<div class="row">
    <div class="col-lg-12">
        <div class="box">
            <div class="box-title">
                <div class="caption">
                    <i class="icon-social-dribbble font-blue-sharp"></i>
            <span class="caption-subject font-blue-sharp bold uppercase">CUSTOMERS | <a href='#myModal-1'
                                                                                        data-toggle='modal'
                                                                                        class='btn btn-info'>
                    Add New <i class="fa fa-plus"></i>
                </a></span>
    ...
    <?php foreach ($vendor as $rows): ?>
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1"
             id="myModal<?php echo $rows->vendor_id; ?>"
             class="modal fade" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                       ...
                       <!--  <div class='form-group'>
                            ...
                            <div class='col-lg-9'>
                                <input type='text' name="address" class='form-control'
                                       value="<?php echo $rows->address; ?>" id='c_oldNo'>
                            </div>
                        </div>-->
