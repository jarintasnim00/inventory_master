                    ...
                    <table class="table table-striped table-hover table-bordered dataTable" id="example1"
                        ...
                        <tr class='odd'>
                            ...
                            <td><?php echo $results->purchase_rate?>
                                 <td><?php echo $results->stock_rate?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body modal-edit">
                    ...
                    <div class='form-group'>
                        <label for='inputPassword1' class='col-lg-3 col-sm-3 control-label'>SALE
                            RATE</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class='form-group'>
                    <label for='inputPassword1' class='col-lg-3 col-sm-3 control-label'>SALE RATE</label>
