            ...
            <div class="box-body">
                ...
                <div id="printableArea">
                  ...
                  <?php if (!empty($invoice_details)): foreach ($invoice_details as $invoice_no => $order_details) : ?>
                                    <?php $total_buying_price = 0; $sales_qty =0; $t=0; ?>
                                    <table>
                                        <thead>
                                        <tr>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr style="background-color: #ECECEC">
                                            ...
                                            <th class="total text-left ">TOTA Sell</th>
                                             <th class="total text-left ">TOTA Buy</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php $k = 1 ?>
                                        <?php if (!empty($order_details)): foreach ($order_details as $v_order) : ?>
                                            <tr>
                                               ...
                                               $t = $t +($sales_qty * $total_buying_price);
                                                ?>
                                                ...
                                                <td class="total"><?php echo number_format($v_order->purchase_rate *  $sales_qty, 2) ?></td>
                                            </tr>
                                            <?php $k++ ?>
                           <!-- <?php $total_cost += $v_order->purchase_rate * $sales_qty; ?>-->
                                        ...
                                        <tr>
                                            <td colspan="3"></td>
                                            <td colspan="2">Grand Total Sell</td>
                                            <td><?php echo  number_format($order[$key]->grand_total, 2) ?></td>
                                        </tr>
                                         <tr>
                                            <td colspan="3"></td>
                                            <td colspan="2">Grand Total Buy</td>
